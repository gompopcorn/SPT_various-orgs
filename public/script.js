...
$(document).ready(function()
{
    ...
    {  
        ...
        else if ($("#mintTokenBtn").attr("enabled") === "true") 
        {
            ...
            {
                method: "POST",
                url: `http://51.38.54.24:3000/tokens/mint`,
        ...
        else if ($("#transfer").attr("enabled") === "true") 
        {
            ...
            if (hasReceivers)
            {
                ...
                {
                    method: "POST",
                    url: `http://51.38.54.24:3000/tokens/transfer`,
...
{  
    ...
    $.ajax(
        {
        method: "POST",
        url: `http://51.38.54.24:3000/users/register`,
...
function getUsersOfOrg(org, dropdownElem, usersClassName)
{
    ...
    {
        method: "GET",
        url: `http://51.38.54.24:3000/users/list/${orgName}`,
...
function getUtxos(username, org)
{
    ...
    {
        method: "POST",
        url: `http://51.38.54.24:3000/tokens/getInfo`,
